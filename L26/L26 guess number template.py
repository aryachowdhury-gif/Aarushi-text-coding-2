...
def intro():
	...
	print(f"{name}, we are going to play a game. I am thinking of a number between 1 to 100 ")
...
def pick():
	...
	while guessesTaken < 6:
		...
		try: 
			...
			if guess > 100 or guess < 1: 
				print("That number isn't in the  in the range!")
				time.sleep(.25)
	...
	if guess == number:
		...
		print(f"Good job, {name}! You guessed the number in {guessesTaken} guessses")
